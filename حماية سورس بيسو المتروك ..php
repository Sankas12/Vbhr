<?php
ob_start();
$API_KEY = "6873838177:AAH9hnudoXBJcFZTrjVhPJ09fLD0FFX_y9M";// توكن بوتك العزيز
$buy = "@BTTT_2";//  يوزرك تليكرام .
$sudo = "6955344750";// خلي ايديك هنا .
$admin = "$sudo";// عوفة لا تبعبص بي .
$idBot = "6873838177";// ايدي بوتك خلي بشكل صحيح .
